...
namespace OpenPol
{
    static public class Startup
    {
        ...
        {
            //AppCenter.Start("08f5e7eb-2194-4446-bd62-25c60ca3bd89", typeof(Analytics), typeof(Crashes));
            AppCenter.Start("08f5e7eb-2194-4446-bd62-25c60ca3bd89", typeof(Analytics));
